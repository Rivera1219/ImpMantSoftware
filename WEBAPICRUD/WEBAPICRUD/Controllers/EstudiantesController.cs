...
using WEBAPICRUD.Datos;
using System.Web.Http.Cors;

namespace WEBAPICRUD.Controllers
{
    [EnableCors(origins: "*", headers: "*", methods: "*")]
    //[EnableCors(origins: "http://localhost:18790/", headers:"*",methods:"*")]
    public class EstudiantesController : ApiController
    {
        private Crud_EstudiantesEntities db = new Crud_EstudiantesEntities();
        ...
        public IHttpActionResult PostEstudiantes(Estudiantes estudiantes)
        {
            ...
            {
                if (EstudiantesExists(estudiantes.cedula))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtRoute("DefaultApi", new { id = estudiantes.cedula }, estudiantes);
        }
        ...
        {
            return db.Estudiantes.Count(e => e.cedula == id) > 0;
        }
    }
}